 ...
 */
final class Version20220303153958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, state_id, location_id, owner_id, name, begin_at, end_at, inscription_max, description, photo, is_display, is_active FROM event');
        ...
        $this->addSql('INSERT INTO event (id, state_id, location_id, owner_id, name, begin_at, limit_inscription_at, inscription_max, description, photo, is_display, is_active) SELECT id, state_id, location_id, owner_id, name, begin_at, end_at, inscription_max, description, photo, is_display, is_active FROM __temp__event');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, state_id INTEGER NOT NULL, location_id INTEGER DEFAULT NULL, owner_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, begin_at DATETIME NOT NULL, end_at DATETIME NOT NULL, site_id INTEGER NOT NULL, inscription_max INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, is_display INTEGER NOT NULL, is_active BOOLEAN NOT NULL, nb_days_before_closing INTEGER NOT NULL)');
        $this->addSql('INSERT INTO event (id, state_id, location_id, owner_id, name, begin_at, end_at, site_id, inscription_max, description, photo, is_display, is_active) SELECT id, state_id, location_id, owner_id, name, begin_at, limit_inscription_at, duration, inscription_max, description, photo, is_display, is_active FROM __temp__event');
        $this->addSql('DROP TABLE __temp__event');
        $this->addSql('CREATE INDEX IDX_3BAE0AA75D83CC1 ON event (state_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA764D218E ON event (location_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA77E3C61F9 ON event (owner_id)');
