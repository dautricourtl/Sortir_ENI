 ...
 */
final class Version20220302132612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, state_id, site_id, location_id, owner_id, name, begin_at, end_at, nb_days_before_closing, inscription_max, description, photo, is_display, is_active FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, state_id INTEGER NOT NULL, site_id INTEGER NOT NULL, location_id INTEGER DEFAULT NULL, owner_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, begin_at DATETIME NOT NULL, limit_inscription_at DATETIME NOT NULL, duration INTEGER NOT NULL, inscription_max INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, is_display INTEGER NOT NULL, is_active BOOLEAN NOT NULL, CONSTRAINT FK_3BAE0AA75D83CC1 FOREIGN KEY (state_id) REFERENCES state (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA7F6BD1646 FOREIGN KEY (site_id) REFERENCES site (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA764D218E FOREIGN KEY (location_id) REFERENCES location (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA77E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event (id, state_id, site_id, location_id, owner_id, name, begin_at, limit_inscription_at, duration, inscription_max, description, photo, is_display, is_active) SELECT id, state_id, site_id, location_id, owner_id, name, begin_at, end_at, nb_days_before_closing, inscription_max, description, photo, is_display, is_active FROM __temp__event');
        ...
        , password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, is_active BOOLEAN NOT NULL, CONSTRAINT FK_8D93D649F6BD1646 FOREIGN KEY (site_id) REFERENCES site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3BAE0AA764D218E');
        $this->addSql('DROP INDEX IDX_3BAE0AA77E3C61F9');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, state_id, site_id, location_id, owner_id, name, begin_at, limit_inscription_at, duration, inscription_max, description, photo, is_display, is_active FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, state_id INTEGER NOT NULL, site_id INTEGER NOT NULL, location_id INTEGER DEFAULT NULL, owner_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, begin_at DATETIME NOT NULL, end_at DATETIME NOT NULL, nb_days_before_closing INTEGER NOT NULL, inscription_max INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, is_display INTEGER NOT NULL, is_active BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO event (id, state_id, site_id, location_id, owner_id, name, begin_at, end_at, nb_days_before_closing, inscription_max, description, photo, is_display, is_active) SELECT id, state_id, site_id, location_id, owner_id, name, begin_at, limit_inscription_at, duration, inscription_max, description, photo, is_display, is_active FROM __temp__event');
        $this->addSql('DROP TABLE __temp__event');
        $this->addSql('CREATE INDEX IDX_3BAE0AA75D83CC1 ON event (state_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7F6BD1646 ON event (site_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__location AS SELECT id, city_id, name, adress, latitude, longitude FROM location');
        $this->addSql('DROP TABLE location');
        $this->addSql('CREATE TABLE location (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, city_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, latitude VARCHAR(255) NOT NULL, longitude VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO location (id, city_id, name, adress, latitude, longitude) SELECT id, city_id, name, adress, latitude, longitude FROM __temp__location');
        $this->addSql('DROP TABLE __temp__location');
        $this->addSql('CREATE INDEX IDX_5E9E89CB8BAC62AF ON location (city_id)');
        $this->addSql('DROP INDEX UNIQ_8D93D64986CC499D');
        ...
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, site_id INTEGER NOT NULL, pseudo VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, is_active BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO user (id, site_id, pseudo, roles, password, name, surname, tel, mail, is_active) SELECT id, site_id, pseudo, roles, password, name, surname, tel, mail, is_active FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D64986CC499D ON user (pseudo)');
        $this->addSql('CREATE INDEX IDX_8D93D649F6BD1646 ON user (site_id)');
