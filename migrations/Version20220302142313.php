 ...
 */
final class Version20220302142313 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, state_id, site_id, location_id, owner_id, name, begin_at, limit_inscription_at, duration, inscription_max, description, photo, is_display, is_active FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, state_id INTEGER NOT NULL, site_id INTEGER NOT NULL, location_id INTEGER DEFAULT NULL, owner_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, begin_at DATETIME NOT NULL, limit_inscription_at DATETIME NOT NULL, duration INTEGER NOT NULL, inscription_max INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, is_display INTEGER NOT NULL, is_active BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO event (id, state_id, site_id, location_id, owner_id, name, begin_at, limit_inscription_at, duration, inscription_max, description, photo, is_display, is_active) SELECT id, state_id, site_id, location_id, owner_id, name, begin_at, limit_inscription_at, duration, inscription_max, description, photo, is_display, is_active FROM __temp__event');
        $this->addSql('DROP TABLE __temp__event');
        $this->addSql('CREATE INDEX IDX_3BAE0AA75D83CC1 ON event (state_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7F6BD1646 ON event (site_id)');
